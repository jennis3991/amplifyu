...
borderRadius: 14, overflow: "hidden", boxShadow: "0 4px 16px rgba(17,28,46,0.18)" }}>
        {image.imageTablet ? (
          <picture>
            ...
            <img loading="lazy" src={image.image} alt={image.alt} style={{ width: "100%", display: "block", aspectRatio: "16 / 9", objectFit: "contain", background: "#8B7355" }}/>
          </picture>
        ) : (
          <img loading="lazy" src={image.image} alt={image.alt} style={{ width: "100%", display: "block", aspectRatio: "1 / 1", objectFit: "cover", objectPosition: image.imgObjectPosition || "center" }}/>
        )}
        {image.captionPosition !== "above" && (
          <>
