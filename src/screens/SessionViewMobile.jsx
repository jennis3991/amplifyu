...
color:T2.text3,fontSize:13,fontWeight:500,cursor:"pointer",
    ...
    <div style={{position:"relative",height:320,overflow:"hidden",background:step==="Rehearsal"?"#141210":step==="Example"||step==="Simulation"?"#0E0B08":"transparent"}}>
      {(()=>{
        ...
        // ── Image lookup tables ────────────────────────────────────────────
        const STEP_IMGS={
          1:{Insight:"/day1-insight.jpg",Theory:"/feynman-technique.jpg",Example:"/day1-insight.jpg",Practice:"/practice-bg.jpg",Simulation:"/day1-simulation.jpg",Review:`/review-chair.jpg?v=${encodeURIComponent(typeof __BUILD_TIME__ !== 'undefined' ? __BUILD_TIME__ : '')}`},
          2:{Insight:"/d2-insight.jpg",Theory:"/d2-theory.jpg",Practice:"/d2-practice.jpg",Review:`/review-chair.jpg?v=${encodeURIComponent(typeof __BUILD_TIME__ !== 'undefined' ? __BUILD_TIME__ : '')}`},
          3:{Insight:"/day3-insight.jpg",Theory:"/day3-theory.jpg",Review:`/review-chair.jpg?v=${encodeURIComponent(typeof __BUILD_TIME__ !== 'undefined' ? __BUILD_TIME__ : '')}`},
          4:{Insight:"/day4-insight.jpg",Theory:"/millers-law.jpg",Practice:"/practice-bg.jpg",Simulation:"/day1-simulation.jpg",Review:`/review-chair.jpg?v=${encodeURIComponent(typeof __BUILD_TIME__ !== 'undefined' ? __BUILD_TIME__ : '')}`},
          5:{Insight:"/d5-insight.jpg",Theory:"/d5-theory.jpg",Practice:"/practice-bg.jpg",Simulation:"/day1-simulation.jpg",Review:`/review-chair.jpg?v=${encodeURIComponent(typeof __BUILD_TIME__ !== 'undefined' ? __BUILD_TIME__ : '')}`},
          6:{Insight:"/d6-insight.jpg",Theory:"/d6-theory.jpg",Practice:"/practice-bg.jpg",Review:`/review-chair.jpg?v=${encodeURIComponent(typeof __BUILD_TIME__ !== 'undefined' ? __BUILD_TIME__ : '')}`},
          7:{Insight:"/day7-insight.jpg",Theory:"/d7-habit-loop.jpg",Practice:"/practice-bg.jpg",Simulation:"/day1-simulation.jpg",Review:`/review-chair.jpg?v=${encodeURIComponent(typeof __BUILD_TIME__ !== 'undefined' ? __BUILD_TIME__ : '')}`},
          9:{Insight:"/day9-insight.jpg",Theory:"/day9-theory.jpg",Review:`/review-chair.jpg?v=${encodeURIComponent(typeof __BUILD_TIME__ !== 'undefined' ? __BUILD_TIME__ : '')}`},
          10:{Insight:"/day10-insight.jpg",Theory:"/performance-iceberg.jpg",Practice:null,Simulation:"/day1-simulation.jpg",Review:`/review-chair.jpg?v=${encodeURIComponent(typeof __BUILD_TIME__ !== 'undefined' ? __BUILD_TIME__ : '')}`},
          11:{Insight:"/d11-insight.jpg",Theory:"/d11-theory.jpg",Practice:null,Review:`/review-chair.jpg?v=${encodeURIComponent(typeof __BUILD_TIME__ !== 'undefined' ? __BUILD_TIME__ : '')}`},
          13:{Insight:"/day13-insight.jpg",Theory:"/day13-theory.jpg",Example:"/day13-insight.jpg",Review:`/review-chair.jpg?v=${encodeURIComponent(typeof __BUILD_TIME__ !== 'undefined' ? __BUILD_TIME__ : '')}`},
          14:{Insight:"/day14-insight.jpg",Theory:"/day14-theory-v2.jpg",Review:`/review-chair.jpg?v=${encodeURIComponent(typeof __BUILD_TIME__ !== 'undefined' ? __BUILD_TIME__ : '')}`},
          12:{Insight:"/day12-insight.jpg",Theory:"/day12-theory-v2.jpg",Practice:null,Simulation:"/day1-simulation.jpg",Review:`/review-chair.jpg?v=${encodeURIComponent(typeof __BUILD_TIME__ !== 'undefined' ? __BUILD_TIME__ : '')}`},
          8:{Insight:"/nt-insight.jpg",Theory:"/dual-coding-theory.jpg",Practice:"/practice-bg.jpg",Simulation:null,Review:`/review-chair.jpg?v=${encodeURIComponent(typeof __BUILD_TIME__ !== 'undefined' ? __BUILD_TIME__ : '')}`},
        };
        // ── Rehearsal panes ────────────────────────────────────────────────
...
T.goldDark : T2.text4,
     ...
     <div key={idx} style={{padding:"20px 20px 0",display:"flex",flexDirection:"column",gap:14,animation:"tabFadeIn 0.28s ease-out"}}>
      ...
      {isD10 && step==="Example" && (()=>{
        ...
        return (
          <>
            ...
            <p style={{fontFamily:T.sans,fontSize:15,color:"#A8998A",lineHeight:1.6,fontWeight:400,marginBottom:6}}>Two leaders who built exceptional performance through process, not just talent.</p>
            <p style={{fontFamily:T.sans,fontSize:10,color:T2.text4,lineHeight:1.5,fontWeight:400,fontStyle:"italic",marginBottom:16}}>AmplifyU's independent analysis of public figures' communication styles. No affiliation or endorsement implied.</p>
       ...
       {isD2 && step==="Example" && (()=>{
        ...
        return (
          <>
            ...
            <p style={{fontFamily:T.sans,fontSize:10,color:T2.text4,lineHeight:1.5,fontWeight:400,fontStyle:"italic",marginBottom:20}}>AmplifyU's independent analysis of public figures' communication styles. No affiliation or endorsement implied.</p>
      ...
      {isD3 && step==="Example" && (()=>{
        const D3_EDITORIAL = [
          { id:"freeman", img:"/d3-freeman.jpg", name:"Morgan Freeman", role:"Actor & narrator", superpower:"Master of the Pause",
        ...
        return (
          <>
            ...
            <p style={{fontFamily:T.sans,fontSize:14,color:"#A8998A",lineHeight:1.6,fontWeight:400,marginBottom:8}}>Two speakers who turned silence into a superpower.</p>
            <p style={{fontFamily:T.sans,fontSize:10,color:T2.text4,lineHeight:1.5,fontWeight:400,fontStyle:"italic",marginBottom:20}}>AmplifyU's independent analysis of public figures' communication styles. No affiliation or endorsement implied.</p>
      ...
      {isD4 && step==="Example" && (()=>{
        const D4_EDITORIAL = [
          ...
          { id:"chanel", img:"/d4-chanel.jpg", imgPos:"center 65%", name:"Coco Chanel", role:"Fashion designer & founder of Chanel", superpower:"Elegance Through Elimination",
        ...
        return (
          <>
            ...
            <p style={{fontFamily:T.sans,fontSize:14,color:"#A8998A",lineHeight:1.6,fontWeight:400,marginBottom:8}}>Two voices that prove less is always more.</p>
            <p style={{fontFamily:T.sans,fontSize:10,color:T2.text4,lineHeight:1.5,fontWeight:400,fontStyle:"italic",marginBottom:20}}>AmplifyU's independent analysis of public figures' communication styles. No affiliation or endorsement implied.</p>
      ...
      {isD1 && step==="Rehearsal" && (
        <D1WarmUpWidget T={T} T2={T2} isDesktop={false} onNavLabel={setD1NavLabel} onNavFn={d1NavFnRef} onComplete={(topic) => { setD1WarmUpTopic(topic); setIdx(i => i + 1); }} onEntitled={onEntitled}/>
      )}
      {isD1 && step==="Simulation" && (
        <>
          ...
          <D1SimWidget T={T} T2={T2} isDesktop={false} warmUpTopic={d1WarmUpTopic} onRecordingChange={setD1SimRecording} onEntitled={onEntitled}/>
        </>
      )}
      ...
      {isNT && step==="Example" && (()=>{
        ...
        return (
          <>
            ...
            <p style={{fontFamily:T.sans,fontSize:15,color:"#A8998A",lineHeight:1.6,fontWeight:400,marginBottom:6}}>Two examples of narrative transportation at its most powerful.</p>
            <p style={{fontFamily:T.sans,fontSize:10,color:T2.text4,lineHeight:1.5,fontWeight:400,fontStyle:"italic",marginBottom:16}}>AmplifyU's independent analysis of public figures' communication styles. No affiliation or endorsement implied.</p>
      ...
      {isNT && step==="Rehearsal" && (
        <D8PracticeWidget T={T} T2={T2} isDesktop={false} onSimulation={()=>setIdx(STEPS.indexOf('Simulation'))} onNavLabel={setD8NavLabel} onNavFn={d8NavFnRef}/>
      )}
      ...
      {isD9 && step==="Example" && (()=>{
        ...
        return (
          <>
            ...
            <p style={{fontFamily:T.sans,fontSize:15,color:"#A8998A",lineHeight:1.6,fontWeight:400,marginBottom:6}}>Two communicators who connect by making others feel heard.</p>
            <p style={{fontFamily:T.sans,fontSize:10,color:T2.text4,lineHeight:1.5,fontWeight:400,fontStyle:"italic",marginBottom:16}}>AmplifyU's independent analysis of public figures' communication styles. No affiliation or endorsement implied.</p>
      ...
      {isD5 && step==="Example" && (()=>{
        const D5_EDITORIAL = [
          { id:"jensen", img:"/d5-jensen.jpg", name:"Jensen Huang", role:"CEO & co-founder of NVIDIA", superpower:"PRE in Every Pitch",
        ...
        return (
          <>
            ...
            <p style={{fontFamily:T.sans,fontSize:14,color:"#A8998A",lineHeight:1.6,fontWeight:400,marginBottom:8}}>Two world-class communicators who organise their ideas so every message is clear, memorable, and easy to follow.</p>
            <p style={{fontFamily:T.sans,fontSize:10,color:T2.text4,lineHeight:1.5,fontWeight:400,fontStyle:"italic",marginBottom:20}}>AmplifyU's independent analysis of public figures' communication styles. No affiliation or endorsement implied.</p>
      ...
      {isD6 && step==="Example" && (()=>{
        ...
        return (
          <>
            ...
            <p style={{fontFamily:T.sans,fontSize:15,color:"#A8998A",lineHeight:1.6,fontWeight:400,marginBottom:6}}>Two voices that stayed composed when everything was on the line.</p>
            <p style={{fontFamily:T.sans,fontSize:10,color:T2.text4,lineHeight:1.5,fontWeight:400,fontStyle:"italic",marginBottom:16}}>AmplifyU's independent analysis of public figures' communication styles. No affiliation or endorsement implied.</p>
      ...
      {isD11 && step==="Theory" && (
        <>
          ...
          <div style={{padding:"12px 14px",background:T2.surface,borderRadius:4,borderLeft:"2px solid "+T2.border,marginBottom:20}}>
            <p style={{fontFamily:T.serif,fontSize:15,fontStyle:"italic",color:T2.text2,lineHeight:1.6,margin:0}}>"People rarely remember everything about you. They remember the strongest signal you gave them."</p>
          </div>
           {/* Brand formula */}
          <div style={{fontFamily:T.sans,fontSize:10,fontWeight:700,color:T.gold,textTransform:"uppercase",letterSpacing:"1.5px",marginBottom:8}}>The AmplifyU Brand Formula</div>
          <p style={{fontFamily:T.sans,fontSize:15,color:"#A8998A",lineHeight:1.6,fontWeight:400,marginBottom:12}}>Six components. Tap any to expand.</p>
          {D11_INGREDIENTS.map((ing,i)=>{
           ...
           <div style={{padding:"14px 16px",background:T2.surface,borderLeft:"3px solid "+T.gold,borderRadius:4,marginTop:4}}>
            <p style={{fontFamily:T.serif,fontSize:15,fontStyle:"italic",color:T.gold,margin:0,lineHeight:1.6}}>Your brand is the story people tell themselves about you after repeated exposure.</p>
          </div>
        </>
      )}
      {isD11 && step==="Example" && (()=>{
        ...
        return (
          <>
            ...
            <p style={{fontFamily:T.sans,fontSize:15,color:"#A8998A",lineHeight:1.6,fontWeight:400,marginBottom:6}}>A personal brand built by design — not by accident.</p>
            <p style={{fontFamily:T.sans,fontSize:10,color:T2.text4,lineHeight:1.5,fontWeight:400,fontStyle:"italic",marginBottom:16}}>AmplifyU's independent analysis of public figures' communication styles. No affiliation or endorsement implied.</p>
      ...
      {isD12 && step==="Example" && (()=>{
        ...
        return (
          <>
            ...
            <p style={{fontFamily:T.sans,fontSize:15,color:"#A8998A",lineHeight:1.6,fontWeight:400,marginBottom:6}}>Two communicators who prove that how you carry yourself speaks louder than words.</p>
            <p style={{fontFamily:T.sans,fontSize:10,color:T2.text4,lineHeight:1.5,fontWeight:400,fontStyle:"italic",marginBottom:16}}>AmplifyU's independent analysis of public figures' communication styles. No affiliation or endorsement implied.</p>
...
strokeLinecap="round"/></svg>
      ...
      {isD14 && step==="Theory" && (
        <>
          ...
          <div style={{marginBottom:16,padding:"14px",background:T2.surface,borderRadius:8,border:"0.5px solid "+T2.border}}>
            <D14LoopDiagram T={T} T2={T2} isDesktop={false}/>
          </div>
      ...
      {isD14 && step==="Rehearsal" && (
        <>
          <D14PracticeWidget T={T} T2={T2} isDesktop={false} onSimulation={()=>setIdx(STEPS.indexOf('Simulation'))} onNavLabel={setD14NavLabel} onNavFn={d14NavFnRef}/>
        </>
      )}
      ...
      {isD13 && step==="Example" && (()=>{
        ...
        return (
          <>
            ...
            <p style={{fontFamily:T.sans,fontSize:15,color:"#A8998A",lineHeight:1.6,fontWeight:400,marginBottom:6}}>Reputations that open doors — built through trust, not just talent.</p>
            <p style={{fontFamily:T.sans,fontSize:10,color:T2.text4,lineHeight:1.5,fontWeight:400,fontStyle:"italic",marginBottom:16}}>AmplifyU's independent analysis of public figures' communication styles. No affiliation or endorsement implied.</p>
...
strokeLinecap="round" strokeLinejoin="round"/></svg>
        ...
        {idx < STEPS.length-1 && (() => {
          ...
          <button
            onClick={()=>{
              ...
              else if (isNT && step==="Rehearsal" && d8NavFnRef.current) { d8NavFnRef.current(); }
              else if (isD13 && step==="Rehearsal" && d13NavFnRef.current) { d13NavFnRef.current(); }
              else if (isD14 && step==="Rehearsal" && d14NavFnRef.current) { d14NavFnRef.current(); }
              else { setIdx(i=>i+1); }
            }}
      ...
      <div style={{
        display:"flex",alignItems:"center",justifyContent:"center",
        gap:5,paddingBottom:"calc(24px + env(safe-area-inset-bottom, 0px))",
      }}>
        {STEPS.map((s,i) => (
