    ...
    return (
      <div style={{ background: T2.bg, minHeight: "100vh" }} className="au-page">
        ...
        <div style={{ marginTop: NAV_H, background: "#0a0805", position: "relative", overflow: "hidden" }}>
          ...
          <img src="/home-hero-8.jpg" alt="The Six Pillars of Communication Mastery" style={{ width: "100%", height: "auto", display: "block", transition: "opacity 0.4s ease", opacity: 0, }} onLoad={e=>e.currentTarget.style.opacity="1"}/>
  ...
  return (
    <div style={{background:T2.bg,minHeight:"100vh"}} className="au-page">
      ...
      <div style={{marginTop:NAV_H,background:"#0a0805",position:"relative"}}>
        <img src="/home-hero-mobile.jpg" alt="The Six Pillars of Communication Mastery" style={{width:"100%",height:"auto",display:"block",transition:"opacity 0.4s ease",opacity:0,}} onLoad={e=>e.currentTarget.style.opacity="1"}/>
      </div>
