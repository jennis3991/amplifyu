    ...
    <div style={{background:T2.bg,minHeight:"100vh",paddingBottom:80}}>
      ...
      <div style={{...W,paddingTop:isDesktop?32:24}}>
        <div style={{display:"flex",gap:10,flexWrap:"wrap"}}>
          <button onClick={toggleDark} style={{display:"flex",alignItems:"center",gap:8,padding:"10px 18px",borderRadius:6,border:"0.5px solid "+T2.border,background:"transparent",color:T2.text3,fontFamily:T.sans,fontSize:12,cursor:"pointer"}}>
            {dark
              ? <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#c9a96e" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="4.5"/><line x1="12" y1="2" x2="12" y2="4.5"/><line x1="12" y1="19.5" x2="12" y2="22"/><line x1="4.2" y1="4.2" x2="6" y2="6"/><line x1="18" y1="18" x2="19.8" y2="19.8"/><line x1="2" y1="12" x2="4.5" y2="12"/><line x1="19.5" y1="12" x2="22" y2="12"/><line x1="4.2" y1="19.8" x2="6" y2="18"/><line x1="18" y1="6" x2="19.8" y2="4.2"/></svg>
              : <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={T2.text3} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z"/></svg>}
