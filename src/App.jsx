...
reset</button>
      ...
      <div ref={scrollRef} className="au-grain-wrap" style={{flex:1,overflowY:"auto",marginLeft:0,paddingBottom:0,background:dark?"#19160F":T.bg}}>
        {tab==="home" && <HomeScreen done={done} cur={cur} streak={streak} onStart={startSession} roleId={roleId} activeRole={activeRole} dark={dark} DK={DK} showNudge={showNudge} onDismissNudge={()=>setShowNudge(false)} isDesktop={isDesktop} onOpenTab={(t)=>{try{localStorage.setItem("au1_open_toolkit_tab",t);}catch{}setTab("toolkit");}} onGoToProgramme={()=>setTab("sessions")} toggleDark={toggleDark}/>}
