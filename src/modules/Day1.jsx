...
export function D1ClarityChallenge({T, T2, isDesktop, onSimulation, onNavLabel, onNavFn}) {
  ...
  const ROUNDS = [
    ...
    {id:2, type:'cardsort', label:'Round 2', name:'The Feynman Formula', pts:25,
     ...
     cards:[
       {text:"🌑 New Moon → 🌒 Crescent → 🌓 Quarter → 🌔 Gibbous → 🌕 Full Moon → then back again — eight phases completing one 29.5-day cycle.", bucket:'learn'},
       ...
       {text:"Most people think moon phases are caused by Earth's shadow — but Earth's shadow only causes a lunar eclipse.", bucket:'gaps'},
       {text:"The Moon never changes shape — we just see different amounts of its sunlit side as it orbits Earth.", bucket:'simplify'},
     ],
