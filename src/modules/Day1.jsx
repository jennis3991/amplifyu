...
export function D1ClarityChallenge({T, T2, isDesktop, onSimulation, onNavLabel, onNavFn}) {
  ...
  const ROUNDS = [
    ...
    {id:2, type:'cardsort', label:'Round 2', name:'The Feynman Formula', pts:25,
     ...
     cards:[
       {text:"The Moon doesn't make its own light — it reflects light from the Sun. As it orbits Earth, we see different amounts of its sunlit half. The cycle takes about 29.5 days.", bucket:'understand'},
       {text:"Imagine holding a football in a dark room with a lamp. The lamp is the Sun, you are Earth, the football is the Moon. As it moves around you, you see different parts of its lit side.", bucket:'explain'},
       {text:"Many people think moon phases are caused by Earth's shadow — but that only happens during a lunar eclipse. What actually changes is the angle between the Sun, Earth, and Moon.", bucket:'refine'},
       {text:"The Moon never changes shape. It's like a cookie lit by a torch — always half lit. As you walk around it, you see different amounts of the lit side.", bucket:'simplify'},
     ],
