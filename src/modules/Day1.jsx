...
export function D1ClarityChallenge({T, T2, isDesktop, onSimulation, onNavLabel, onNavFn}) {
  ...
  const ROUNDS = [
    ...
    {id:2, type:'cardsort', label:'Round 2', name:'The Feynman Formula', pts:25,
     ...
     feedback:"The Feynman Technique is the foundation of clear communication. When you understand something deeply enough to explain it simply, your message lands. When you can't, jargon fills the gap. The communicators people trust most aren't the ones who sound the most complex — they're the ones who make complex things feel obvious."},
