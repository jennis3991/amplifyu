...
export function D1ClarityChallenge({T, T2, isDesktop, onSimulation, onNavLabel, onNavFn}) {
  ...
  const ROUNDS = [
    ...
    {id:2, type:'cardsort', label:'Round 2', name:'The Feynman Formula', pts:25,
     ...
     feedback:"The Feynman Technique is the engine behind clarity. When you can explain an idea simply — the way Ella explained the Moon to her nephew — you've genuinely understood it. The one-sentence test: \"Moon phases happen because the Moon moves around Earth, and from Earth we see different amounts of the Moon's sunlit side.\" 🌙 That's not simplification. That's mastery."},
