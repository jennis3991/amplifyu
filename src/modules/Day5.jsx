  ...
  if (phase === 'bridge') return (
    <div style={{display:'flex', flexDirection:'column', gap:isDesktop?16:14}}>
      <div>
        ...
        <p style={{fontFamily:T.sans, fontSize:isDesktop?14:13, color:T2.text3, lineHeight:1.7, margin:'0 0 14px', fontWeight:300}}>PRE is a three-part framework that makes any spoken answer clear, convincing, and easy to follow.</p>
...
Never use em dashes in headlineVerdict, comparisonInsight, or takeaway; use a comma or hyphen instead.
    ...
    return (
      <div style={{display:'flex', flexDirection:'column', gap:isDesktop?14:12}}>
        ...
        <div style={cs.card}>
          ...
          <p style={{fontFamily:T.sans, fontSize:isDesktop?13:12, color:T2.text3, lineHeight:1.6, margin:0}}>Structuring your answer on the spot only becomes instinct once you've said it out loud under pressure — twice, just now. The next time someone asks your opinion out of nowhere, this is the shape it'll fall into.</p>
        </div>
      </div>
    );
  }
