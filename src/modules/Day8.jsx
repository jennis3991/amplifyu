...
6 scenes exactly. Match the brief completely. Never use em dashes anywhere in your response; use a comma or hyphen instead.`
          }]
        })
      });
      const d = await res.json();
